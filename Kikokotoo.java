 ...
 * @author user
 */
public class Kikokotoo extends javax.swing.JFrame {

    /**
     * Creates new form Kikokotoo
     */
    public Kikokotoo() {
        initComponents();
...
enable();        // TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Kikokotoo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
